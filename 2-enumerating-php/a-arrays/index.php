...
<html lang="en">
    ...
    <?php
        ...
        # - Titles -
            ...
            $productsTitle = 'What is it that we do?';

        # - Products -
            # Standard array - put similar values inside a single variable
            $products = ['Creating Management Systems', 'Building Websites', "Developing 3rd party API's"];
        ...
        # - Contact Info -
            ...
            # Associative Array - define your own indexes
            $contactDetails = [
    ...
    <body>
        ...
        <main class="main">
            ...
            <section>
                ...
                <div class="box">
                    <?php echo "<a href='#'> <b>" . $products[0] . " </b></a> <br><br>"; ?>
                ...
                <div class="box">
                    <?php echo "<a href='#'> <b> " . $products[1] . " </b></a> <br><br>"; ?>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque saepe odio ex beatae nulla cum 
                    accusantium quo ipsa blanditiis at velit, earum nostrum. Saepe assumenda ipsam velit, doloribus
                    obcaecati reprehenderit?
                </div>
                ...
                <div class="box">
                    <?php echo "<a href='#'> <b> " . $products[2] . " </b></a> <br><br>"; ?>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque saepe odio ex beatae nulla cum 
                    accusantium quo ipsa blanditiis at velit, earum nostrum. Saepe assumenda ipsam velit, doloribus
                    obcaecati reprehenderit?
                </div>
        ...
        <footer class="footer">
            ...
            <div class="contact">
                ...
                <h3> 
                    Tel : <?php echo $contactDetails['telephone']; ?> 
                </h3>
                <h3> 
                    Address : <?php echo $contactDetails['address']; ?> 
                </h3>
            </div>
